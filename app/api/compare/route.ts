...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemPrompt = [
      ...
      '  "confidenceA": number 0–100 — evidence density / specificity for document A,',
      '  "confidenceB": number 0–100 — same for document B,',
      '  "confidenceNote": "string — one sentence on how interpretive confidence differs, with attribution framing",',
